            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1 space-y-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                  The platform uses Tether (USDT) to back all community rewards. 1 USDT is fully backed 1:1 with USD reserves verified by global audit.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-white/50 dark:bg-slate-900/50 rounded-2xl border border-white dark:border-slate-800">
                    ...
                    <p className="text-2xl font-black text-gray-900 dark:text-white">
                      {(parseFloat(account.balances.find((b: any) => b.asset === 'USDT' || b.asset === 'PAXG')?.free || '0')).toFixed(2)} USDT
                    </p>
                  </div>
                  <div className="p-4 bg-white/50 dark:bg-slate-900/50 rounded-2xl border border-white dark:border-slate-800">
