  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 prose dark:prose-invert max-w-none">
        ...
        <p>
          Pulse Feeds is a complex, multi-layered platform integrating social networking, artificial intelligence (AI), community problem-solving (AI Eye), and a proprietary reward system. These Terms are designed to provide a comprehensive legal framework for all these interactions, ensuring a safe, transparent, and legally compliant environment for all users globally.
        </p>
        <p>
        ...
        <ul>
          <li><strong>"Account"</strong> means a unique account created for You to access our Service or parts of our Service, including your profile and wallet.</li>
          <li><strong>"AI Engine"</strong> refers to the suite of artificial intelligence models integrated into the App, primarily powered by Gemini 3 Flash and other proprietary algorithms, used for content generation, problem analysis, and community moderation.</li>
        ...
        <h3>6.2 Revenue Sharing and Distribution Policies</h3>
        <p>
          Pulse Feeds utilizes a multi-tiered revenue distribution model to ensure platform sustainability and user reward:
        </p>
        <ul>
          <li><strong>User Activity (60/40 Distribution):</strong> Revenue generated from general user activity, including social interactions, community discussions, and active engagement, is distributed as a 60% split for the User and 40% for Platform maintenance. This distribution is exclusive of direct user payments.</li>
          <li><strong>Platform Primary Revenue (100% Platform):</strong> Revenue generated from Ads, App Creation fees, system optimizations, and all direct user payments (e.g., memberships, subscriptions, event tickets, sponsorships, premium unlocks), is retained 100% by the Platform.</li>
        </ul>
