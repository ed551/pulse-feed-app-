    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 prose dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Reward Mechanism (Learn & Earn):</strong> For course enrollments and AI-driven training modules, an 80/20 revenue distribution applies. 80% of the fee is retained by Pulse Feeds for platform maintenance and AI research, while 20% is credited to the User's wallet as a "Learn & Earn" reward. This reward is subject to the monthly withdrawal cycle.</li>
