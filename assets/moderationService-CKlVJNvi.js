import{I as p,a1 as t}from"./index-_3lPnyMD.js";const i={sensitivity:"medium",customRules:["No hate speech or harassment","No explicit or adult content","No spam or self-promotion"]},c=()=>{const e=localStorage.getItem("moderation_settings");if(e)try{return JSON.parse(e)}catch{return i}return i},l=e=>{localStorage.setItem("moderation_settings",JSON.stringify(e))},m=async(e,r)=>{if(!e||e.trim()==="")return{isApproved:!0};const s=c(),a=`
