...
## 3. Log Data
In the event of a system error or technical issue, we collect data—via third-party products—known as Log Data. This may include:
*   Your device’s Internet Protocol (“IP”) address.
*   Device name and operating system version.
*   App configuration settings and the specific time and date of your use.

## 4. Cookies and Tracking
Cookies are small data files utilized as anonymous unique identifiers.
*   **Explicit Use:** While this service does not use "cookies" explicitly, the app may incorporate third-party code and libraries that use cookies to enhance their service quality.
*   **User Control:** You maintain the option to accept or refuse these cookies. Please note that refusing cookies may limit your access to certain segments of the service.

## 5. Service Providers
We may engage third-party companies and individuals for the following purposes:
*   To facilitate and perform service-related tasks on our behalf.
*   To assist in analyzing user interaction and platform performance.
*   **Confidentiality:** These third parties have access to your Personal Information solely to perform assigned tasks and are strictly prohibited from disclosing or using this information for any other purpose.

## 6. Data Security
We value your trust in providing your Personal Information and strive to use commercially acceptable means to protect it. However, please be advised that no method of electronic transmission or storage is 100% secure, and we cannot guarantee absolute security.
